...
const Calender = () => {
  ...
  return (
    <>
      <div className="bg-selected h-24 w-full flex">
        <div className="flex ml-6 bg-selected items-center w-1/2 h-full">
          ...
          <ul className="flex w-full h-full">
            {dates.map((date, index) => (
              <li key={index} className="w-full bg-yellow-300">
                <button onClick={() => handleDateSelect(date)} className={`w-full h-full ${date.day === selectedDate.day ? 'bg-blue-800 text-white' : 'bg-selected text-white'}`}>
        ...
        <label className="flex flex-col items-start ml-4">
            ...
            <select value={time} onChange={onChangeTime} className="bg-selected text-white">
        ...
        <label className="flex flex-col items-start">
            ...
            <select value={theater} onChange={onChangeTheater} className="bg-selected text-white">
